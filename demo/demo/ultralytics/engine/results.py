...
class Results(SimpleClass):
    ...
    def plot(
        ...
        self.annotator_img = annotator.get_img()
    ...
    def get_annotator_img(self, *args, **kwargs):
        self.plot(show=False, *args, **kwargs)
        return self.annotator_img
